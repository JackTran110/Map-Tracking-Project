 ...
 * */
class BBCAdapter_DB extends BaseAdapter {
     ...
     */
    public BBCAdapter_DB(Context ctx, List<BBCNews> list) {
        setNewsList(list);
        this.ctx = ctx;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.bbc_favorite_item, parent, false);
        }

        TextView titleView = convertView.findViewById(R.id.fav_title);
        TextView dateView = convertView.findViewById(R.id.fav_date);
        TextView descView = convertView.findViewById(R.id.fav_desc);
        TextView linkView = convertView.findViewById(R.id.fav_link);
